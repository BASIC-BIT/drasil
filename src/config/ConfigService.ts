...
import {
  ...
  VERIFICATION_AI_RESTRICT_THRESHOLD_SETTING_KEY,
...
import {
  ...
  DEFAULT_CASE_RESPONDER_THREAD_MEMBER_CAP,
...
export class ConfigService implements IConfigService {
  ...
  private createDefaultConfig(guildId: string): Server {
    ...
    const defaultSettings: ServerSettings = {
      ...
      [DETECTION_RESPONSE_MODE_SETTING_KEY]: 'restrict',
      [MESSAGE_DETECTION_RESPONSE_MODE_SETTING_KEY]: 'restrict',
      [JOIN_DETECTION_RESPONSE_MODE_SETTING_KEY]: 'restrict',
      [OBSERVED_DETECTION_MIN_CONFIDENCE_THRESHOLD_SETTING_KEY]:
        DEFAULT_OBSERVED_DETECTION_MIN_CONFIDENCE_THRESHOLD,
      [OBSERVED_DETECTION_NOTIFICATION_WINDOW_MINUTES_SETTING_KEY]:
        DEFAULT_OBSERVED_DETECTION_NOTIFICATION_WINDOW_MINUTES,
      ...
      [CASE_RESPONDER_ROLE_IDS_SETTING_KEY]: [],
      [CASE_RESPONDER_ROUTING_MODE_SETTING_KEY]: DEFAULT_CASE_RESPONDER_ROUTING_MODE,
      [CASE_RESPONDER_THREAD_MEMBER_CAP_SETTING_KEY]: DEFAULT_CASE_RESPONDER_THREAD_MEMBER_CAP,
      [REPORT_AI_TRIAGE_ENABLED_SETTING_KEY]: false,
