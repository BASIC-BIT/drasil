...
const requestActionLabels: Record<string, string> = {
  ...
  ban_case_user_with_message_cleanup: 'Ban Case User with Message Cleanup',
  ...
  execute_case_message_deletion: 'Execute Case Message Cleanup',
  ...
  preview_case_message_deletion: 'Preview Case Message Cleanup',
